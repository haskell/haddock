...
package depends on this module ('Haddock.Data.DList.Internal'), we don't perform the
...
module Haddock.Data.DList.Internal where
...
-- CPP: base >= 4.8 for toList in Foldable
  ...
  {-# INLINE toList #-}
  toList = Haddock.Data.DList.Internal.toList
#endif
