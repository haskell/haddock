...
ppHoogle :: DynFlags -> String -> Version -> String -> Maybe (Doc ty RdrName) -> [(Interface ty)] -> FilePath -> IO ()
...
ppModule :: DynFlags -> Interface ty -> [String]
...
ppExport :: DynFlags -> ExportItem ty GhcRn -> [String]
...
ppSigWithDoc :: DynFlags -> Sig GhcRn -> [(Name, DocForDecl ty Name)] -> [String]
...
ppClass :: DynFlags -> TyClDecl GhcRn -> [(Name, DocForDecl ty Name)] -> [String]
...
ppData :: DynFlags -> TyClDecl GhcRn -> [(Name, DocForDecl ty Name)] -> [String]
...
lookupCon :: DynFlags -> [(Name, DocForDecl ty Name)] -> Located Name -> [String]
lookupCon dflags subdocs (L _ name) = case lookup name subdocs of
  Just (d, _) -> ppDocumentation dflags d
  _ -> []

ppCtor :: DynFlags -> TyClDecl GhcRn -> [(Name, DocForDecl ty Name)] -> ConDecl GhcRn -> [String]
...
ppDocumentation :: Outputable o => DynFlags -> Documentation ty o -> [String]
ppDocumentation dflags (Documentation d w) = mdoc dflags d ++ doc dflags w


doc :: Outputable o => DynFlags -> Maybe (Doc ty o) -> [String]
doc dflags = docWith dflags ""

mdoc :: Outputable o => DynFlags -> Maybe (MDoc ty o) -> [String]
mdoc dflags = docWith dflags "" . fmap _doc

docWith :: Outputable o => DynFlags -> String -> Maybe (Doc ty o) -> [String]
docWith _ [] Nothing = []
...
mkSubdoc :: DynFlags -> Located Name -> [(Name, DocForDecl ty Name)] -> [String] -> [String]
